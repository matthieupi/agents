...
> Research + full analysis go to `.project/research/<slug>/`, vision docs go to `.project/vision/`.
...
Each run gets its **own dedicated folder** under `.project/research/` so
multiple ideation runs don't collide. For example:
- `.project/research/micro-frontend/`
- `.project/research/webassembly/`
- `.project/research/html-compiler/`
...
- **Output path**: `.project/research/<slug>/0N-<angle-slug>.md` (e.g., `.project/research/webassembly/01-industry-and-decisions.md`). Use zero-padded two-digit numbering (01, 02, ... 09, 10, ...).
...
> ✅ Research complete (`.project/research/<slug>/`):
> - `01-<angle>.md` — N lines
> - `02-<angle>.md` — N lines
...
- **Mode**: `analysis`
- **Research directory**: `.project/research/<slug>/`
- **Output path**: `.project/research/<slug>/0{N+1}-<slug>-analysis.md`
...
- **Mode**: `summary`
- **Research directory**: `.project/research/<slug>/`
- **Output path**: `.project/vision/<Slug>-summary.md`
- **Codebase context**: List the key source files the agent should read
  for architecture assessment (identify these from the codebase structure)
...
- **Topic**: The strategic question
- **Research directory**: `.project/research/<slug>/`
- **Propositions path**: `.project/vision/<Slug>-propositions.md`
- **Whitepaper path**: `.project/vision/<Slug>-whitepaper.md`
- **Codebase context**: List the key source files the agent should read
  for architecture assessment (identify these from the codebase structure)

Full mode produces:
1. A focused **900–1,200 line full analysis report** in `.project/research/<slug>/`
2. A standalone **200–350 line executive summary** in `.project/vision/`
3. A **200–400 line technical propositions** document in `.project/vision/`
4. A **300–500 line whitepaper** in `.project/vision/`
...
1. A **200–400 line technical propositions** document in `.project/vision/`
2. A **300–500 line whitepaper** in `.project/vision/`
...
> |------------|------|------|
> | Full Analysis | `.project/research/<slug>/0{N+1}-<slug>-analysis.md` | ~1,000 lines |
> | Executive Summary | `.project/vision/<Slug>-summary.md` | ~250 lines |
> | Technical Propositions | `.project/vision/<Slug>-propositions.md` | ~300 lines |
> | Whitepaper | `.project/vision/<Slug>-whitepaper.md` | ~400 lines |
>
...
>
> **📄 How to read these:**
> - **5 min**: Executive summary (`.project/vision/<Slug>-summary.md`) — the board-meeting briefing
> - **15 min**: Add the propositions (`.project/vision/<Slug>-propositions.md`) — see what we could build
> - **30 min**: Add the whitepaper (`.project/vision/<Slug>-whitepaper.md`) — understand the deeper argument
> - **60 min**: The full analysis (`.project/research/<slug>/0{N+1}-*-analysis.md`) — every detail, every number, every tradeoff
...
>
> **📄 How to read these:**
> - **10 min**: Propositions (`.project/vision/<Slug>-propositions.md`) — see what we could build
> - **20 min**: Whitepaper (`.project/vision/<Slug>-whitepaper.md`) — understand the deeper argument
> - **Browse**: Research files in `.project/research/<slug>/` — raw data and evidence
