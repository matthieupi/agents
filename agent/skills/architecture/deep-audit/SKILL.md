...
> **Output:** `.project/audits/<subsystem>/`
>
> Proceed with audit?
...
Create the output directory: `.project/audits/<subsystem>/`
...
**Output:** `.project/audits/<subsystem>/01-architecture.md`
...
**Output:** `.project/audits/<subsystem>/02-api-contracts.md`
...
**Output:** `.project/audits/<subsystem>/03-quality-risks.md`
...
**Output:** `.project/audits/<subsystem>/04-extensibility.md`
...
**Output:** `.project/audits/<subsystem>/05-improvements.md`
...
**Output:** `.project/audits/<subsystem>/01-architecture-api.md`
...
**Output:** `.project/audits/<subsystem>/02-quality-extensibility.md`
...
> Analysis complete (`.project/audits/<subsystem>/`):
...
**Output:** `.project/audits/<subsystem>/0{N+1}-<subsystem>-audit.md`
