---
name: distill
description: Reduce subsystem entropy through orchestrated agent dialogue. Spawns an analyst agent and guides it through progressive discovery — exploration, simplification proposals, boundary challenges, and refinement — mirroring how a skilled architect interviews a system. Use when user wants to simplify a subsystem, reduce complexity, question architectural boundaries, or mentions "distill".
argument-hint: "<subsystem>  e.g. 'router', 'actor system', 'schema pipeline', 'auth'"
---

# Distill: Entropy Reduction Through Orchestrated Agent Dialogue
...
## Output
Write to: .project/features/<subsystem>-distill/design.md
